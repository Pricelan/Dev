...
export default function SoftwareShopPage() {
 ...
 useEffect(() => {
    fetch("http://localhost:8080/api/software")
      .then(res => res.json())
      .then(data => {
        // FILTER: Nur Einträge mit der Kategorie "FREEWARE"
        const filtered = data.filter((s: Software) => s.kategorieListe === "FREEWARE");
  ...
  return (
   <div className="p-6 max-w-5xl mx-auto">
    ...
    <div className="max-w-5xl mx-auto">
      <h1 className="text-3xl font-bold mb-2">Kostenlose Software</h1>
      <p className="text-gray-600 mb-8">
        Wähle eine Software aus und lege sie in den Warenkorb.
      </p>
