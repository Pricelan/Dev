...
export default function SoftwareShopPage() {
 ...
 useEffect(() => {
    fetch("http://localhost:8080/api/software")
      .then(res => res.json())
      .then(data => {
        // FILTER: Nur Einträge mit der Kategorie "SOFTWARE"
        const filtered = data.filter((s: Software) => s.kategorieListe === "SOFTWARE");
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">Software-Shop</h1>
